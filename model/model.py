...
class RPN3D(object):
    ...
    def __init__(self,
        ...
        lr = tf.compat.v1.train.exponential_decay(self.learning_rate, self.global_step, 10000, 0.96)
        ...
        self.train_summary = tf.compat.v1.summary.merge([
            ...
            *[tf.compat.v1.summary.histogram(each.name, each) for each in self.params]
        ])
